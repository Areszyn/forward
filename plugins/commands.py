...
main_buttons = [[
        InlineKeyboardButton('📢 Updates', url='https://t.me/neprosz'),
        InlineKeyboardButton('💬 Support', url='https://t.me/waspros')
        ],[
        InlineKeyboardButton('🛠️ Help', callback_data='help'),
        InlineKeyboardButton('🩷 About', callback_data='about')
        ],[
        InlineKeyboardButton('🧑‍💻 Developer 🧑‍💻', url='https://t.me/waspros')
        ]]
